...
Debugging:
The script randomly stores some queries while processing all sessions.
When the script halts with "Please enter a command", type a number N and randomly sample N queries to print to the screen
