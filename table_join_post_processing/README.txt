This script processes session csv files in ../output to extract only the statements of each row, then store the statements of each session in ../output_processed.
